...
const SectionsDetails = ({
  ...
  return (
    <div className="px-6 py-4 flex flex-col gap-5">
      ...
      {isLocked ? (
        <div className="px-10 py-10 flex flex-col gap-5 items-center bg-[#FFF8EB]">
          <Lock className="h-8 w-8" />
          <p className="text-sm font-bold">
            Видео для этого раздела заблокировано! Пожалуйста, купите курс,
      ...
      <div>
        <h2 className="text-xl font-bold mb-5">Материалы</h2>
