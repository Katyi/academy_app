...
const TopBar = () => {
  ...
  const topRoutes = [
    { label: 'Преподаватель', path: '/instructor/courses' },
    { label: 'Ученик', path: '/learning' },
  ];

  const sidebarRoutes = [
    { label: 'Курсы', path: '/instructor/courses' },
    {
      label: 'Продажи',
  ...
  return (
    <div className="flex justify-between items-center p-4">
      <Link href="/">
        <Image src="/myLogo.png" height={100} width={200} alt="logo" />
      </Link>
      ...
      <div className="flex gap-6 items-center">
        ...
        <div className="w-full max-x-[200px] z-20 sm:hidden">
          <Sheet>
            <SheetTrigger>
