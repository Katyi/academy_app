        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 mb-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Пример: станьте разработчиком. HTML, CSS, Javascript, Node, React, MongoDB и многое другое!"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <RichEditor placeholder="О чем этот курс?" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                <FormLabel>
                  Баннер Курса <span className="text-red-500">*</span>
                </FormLabel>
                <FormControl>
                  <FileUpload
                    value={field.value || ''}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {/* Цена <span className="text-red-500">*</span> (USD) */}
                  Цена <span className="text-red-500">*</span> (Руб.)
                </FormLabel>
                <FormControl>
                  <Input
                    type="number"
